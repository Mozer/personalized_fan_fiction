...
# Configuration
class Config:
    SHORT_NAME = "prompts_for_clothes_change"
...
- Analyze given INPUT_TEXT and find lines that describe clothes or clothes change.
for each such line output line number with a json describing characters and clothes that are present in this line: {{character_clothes: {{character_id_1:{{"clothes": "clothes description"}}, character_id_2:{{clothes description}}}}}}
- if character is topless - mention it: 'topless, naked chest'. if character is naked - mention it: fully naked.
- if no clothes were mentioned in this line - skip it


E.g. input
9. Warm day started.
10. Sunny and Anna are at their room. Anna is wearing a t-shirt and pants. Sunny adjusted her red crop top.
11. Anna: Where is he?
12. She asked suddenly, her eyes wide, standing in the kitchen.
13. Alex in his blue jacket looked up from the table.

output:
10. {{"character_clothes": {{"Anna": {{"clothes": "t-shirt and pants"}}, "Sunny": {{"clothes": "red crop top"}}}}}}
13. {{"character_clothes": {{"Alex": {{"clothes": "blue jacket"}}}}}}
