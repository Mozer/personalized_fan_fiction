...
class Config:
    ...
    #API_KEY = "yWyunVBBnhMS3hW1p3Crnvej59ruwWBT" 
    API_KEY = "None"  # not used with llama.cpp server, but need to keep some non-empty string here
    ...
    USER_PROMPT_TEMPLATE = """You are a professional text2image prompt designer. Analyze given below novel chapter text and create a text2image prompt describing events in that chapter. Describe location, characters, what are they doing. Don't use old spam tags like '8k, best quality'. Return ONLY the text2image prompt. Start it with text 'Now they are ...'

chapter text:
{funny_text} End of chapter text.
"""
