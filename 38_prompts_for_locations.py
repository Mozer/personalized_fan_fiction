...
# Configuration
class Config:
    SHORT_NAME = "prompts_for_locations"
...
- Analyze given INPUT_TEXT and compose text2image prompts for all the locations mentioned in text. 
- Don't describe characters, just empty locations, without people. "a beedroom where they sleep" - it's a bad example. don't mention people. I want just the empty locations in my images! if you mention words like 'guys' or 'people' it will result in a `photo of a guys at location`, i dont want it. 
- In total there should be 5-10 different locations.

json example:
"locations": 
    "living_room": "The emty living room of a Moscow apartment bathed in oppressive golden morning light streaming through balcony doors. The space feels like a hothouse with amber light and humid air.",
    "kitchen": "Emty kitchen in a Moscow apartment filled with warm, golden light. The air carries the aroma of coffee and something sweet."

In your response, return only the valid json with location prompts:
INPUT_TEXT:
