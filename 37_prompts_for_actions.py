...
# Configuration
class Config:
    SHORT_NAME = "prompts_for_actions"
    EPISODES_INPUT_DIR = Path("textfortts_en_enumerated")
    EPISODES_OUTPUT_DIR = Path(SHORT_NAME+"_en")    
...
- Analyze given INPUT_TEXT and find lines that describe characters actions.
for each such line output line number with a json describing characters and their actions that are present in this line: {{character_actions: {{character_id_1:{{"action": "Action description"}}, character_id_2:{{action: "Action description"}}}}}}
- if no actions were mentioned in this line - skip it


E.g. input
9. Warm day started.
10. Sunny and are Anna are at kitchen room. Anna wearing a t-shirt and pants stood up. Sunny adjusted her red crop top.
11. Anna: Where is he?
12. She asked suddenly, her eyes wide and innocent, standing in the kitchen.
13. Alex in his jacket looked up from the table. He was drinking tea.

output:
10. {{"character_actions": {{"Anna": {{"action": "She stood up"}}}}, {{"Sonny": {{"action": "She adjusted her red crop top"}}}}}}
12. {{"character_actions": {{"Anna": {{"action": "Her eyes are wide and innocent, standing in the kitchen"}}}}}}
13. {{"character_actions": {{"Alex": {{"action": "He looked up from the table. he is drinking tea"}}}}}}
